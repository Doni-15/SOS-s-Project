...
export const OwnerLoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const success = login(username, password, 'owner');
      if (success) {
        navigate('/owner');
      } else {
    ...
    <div className="min-h-screen flex flex-row bg-white">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 to-blue-800 flex-col justify-center items-center p-12">
        <div className="text-center text-white">
          ...
          <h1 className="text-4xl font-bold mb-4">Kelola usaha restoran</h1>
          <h2 className="text-4xl font-bold mb-8">lebih mudah, terukur,</h2>
          <h3 className="text-4xl font-bold mb-8">dan menguntungkan.</h3>
          <p className="text-blue-100 text-lg max-w-md">
            Pantau penjualan, kelola transaksi, dan kembangkan bisnis Anda dalam satu platform.
          </p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600">Sistem Pemilik Usaha Resto Nusantara</p>
          </div>

          {/* Role Badge */}
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-6 text-center">
            <span className="text-blue-600 font-semibold">👤 Akses Pemilik Usaha</span>
          </div>
          ...
          <div className="mt-8 pt-6 border-t border-gray-200">
            <div className="flex items-center gap-2 text-sm text-gray-600 justify-center">
              <span>✓</span>
              <span>Akses hanya untuk pemilik usaha yang terdaftar dan terverifikasi.</span>
            </div>
          </div>
        </div>
      </div>
